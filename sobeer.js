      ...
      +'<div class="bar-detail"><div class="bar-detail-inner">'
        +'<div>'
          +'<div class="detail-cols">'
            ...
            +'</div>'
            +'<div class="detail-col">'
              +'<div><div class="dl-label">Čepované</div><div class="dl-value">'+(function(){var t=b.beers.filter(function(x){return x.serve==='Čepované';});return t.length?t.map(function(x){return x.name;}).join('\n'):'Není v nabídce';})()+'</div></div>'
              +'<div><div class="dl-label">Lahvové</div><div class="dl-value">'+(function(){var t=b.beers.filter(function(x){return x.serve==='Lahvové';});return t.length?t.map(function(x){return x.name;}).join('\n'):'Není v nabídce';})()+'</div></div>'
